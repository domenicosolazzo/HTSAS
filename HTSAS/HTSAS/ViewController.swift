...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        lessons.append(HTSASLesson(title: "How to Start a Startup", authors: "Sam Altman, Dustin Moskovitz", videoUrl:"https://www.youtube.com/watch?v=CBYhVcO4WgI", transcripts:["bdsggssagasGSA", "fsaafsasas ffsaafs fafsafssafsfasfasfasaf"]))
