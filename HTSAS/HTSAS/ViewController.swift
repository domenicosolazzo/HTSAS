...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        lessons.append(HTSASLesson(title: "How to Start a Startup", authors: "Sam Altman, Dustin Moskovitz", videoUrl:"https://clip.mn/embed/yt-CBYhVcO4WgI?th=dark&pr=F06531&ap=1&pid=yc&ch=1", transcripts:["bdsggssagasGSA", "fsaafsasas ffsaafs fafsafssafsfasfasfasaf"]))
